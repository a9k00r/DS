// link: https://www.hackerrank.com/challenges/tree-huffman-decoding/problem?h_l=interview&isFullScreen=false&playlist_slugs%5B%5D%5B%5D%5B%5D=interview-preparation-kit&playlist_slugs%5B%5D%5B%5D%5B%5D=trees
/** 
...
*/
    ...
    void decode(String s, Node root) {
        ...
        while (rootp != null && i < s.length()) {
            if (s.charAt(i) == '0' && (rootp.left.left != null || rootp.left.right != null)) {
                rootp = rootp.left;

            } else if (s.charAt(i) == '0' && rootp.left != null && rootp.left.left == null && rootp.left.right == null) {
                result.append(rootp.left.data);
                rootp = root;

            } else if (s.charAt(i) == '1' && (rootp.right.right != null
                    || rootp.right.left != null)) {
                rootp = rootp.right;


            } else if (s.charAt(i) == '1' && rootp.right != null && rootp.right.left == null && rootp.right.right == null) {
                result.append(rootp.right.data);
                rootp = root;
